...
scatterplot3d(x=BurgundyDB4$PR, y=BurgundyDB4$NUMR, 
        z=BurgundyDB4$RT, angle =200, pch = 21, color=fitBurgundy1$cluster * 2,main = "fitBurgundy1");

fitBurgundy2 <- kmeans(BurgundyDB4[,c("PR","Mean_AL","Mean_RSG")], 3);
fitBurgundy2;

scatterplot3d(x=BurgundyDB4$PR, y=BurgundyDB4$Mean_AL, 
              z=BurgundyDB4$Mean_RSG, angle=400, pch = 21, color=fitBurgundy2$cluster * 2,main = "fitBurgundy2");

fitBurgundy3 <- kmeans(BurgundyDB4[,c("PR","BD","AGE")], 3);
fitBurgundy3;1

scatterplot3d(x=BurgundyDB4$PR, y=BurgundyDB4$AGE, 
              z=BurgundyDB4$BD, angle=150, pch = 21, color=fitBurgundy3$cluster * 2,main = "fitBurgundy3");
